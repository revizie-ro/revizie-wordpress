...
?>
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="max-w-4xl mx-auto text-center">
          ...
          <h1 class="text-5xl md:text-7xl font-bold text-foreground mb-6 leading-tight">
            ...
            <span class="block bg-gradient-to-r from-accent via-accent-hover to-warning bg-clip-text text-transparent">intr-un singur loc</span>
          </h1>

          <p class="text-xl text-foreground-muted mb-10 leading-relaxed max-w-2xl mx-auto">
            Garaj digital, marketplace de masini second-hand, asigurari RCA online si verificare istoric prin VIN. Lansare in 2026, integrari noi adaugate continuu.
          </p>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div class="text-center">
              <div class="text-2xl md:text-3xl font-bold text-foreground mb-1">Lansare 2026</div>
              <div class="text-sm text-foreground-subtle">Platforma noua</div>
            </div>
            <div class="text-center">
            ...
            <div class="text-center">
              <div class="text-2xl md:text-3xl font-bold text-foreground mb-1">AI-powered</div>
              <div class="text-sm text-foreground-subtle">VIN decoder integrat</div>
            </div>
            <div class="text-center">
  ...
  <!-- Live features — what the app actually does today -->
    ...
    <div class="max-w-7xl mx-auto px-6">
      <div class="text-center mb-16">
        <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-accent-soft rounded-full text-accent-strong text-sm font-medium mb-4">
          ...
          Functionalitati disponibile acum
        </div>
        <h2 class="text-4xl md:text-5xl font-bold text-foreground mb-4">Ce poti face de la lansare</h2>
        <p class="text-xl text-foreground-muted max-w-2xl mx-auto">5 instrumente esentiale pentru orice posesor de masina, gata sa fie folosite.</p>
      </div>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <a href="<?php echo home_url('/functii/garaj-digital/'); ?>" class="group bg-gradient-to-br from-accent-soft to-card rounded-3xl p-8 hover:shadow-xl transition-all duration-300 border border-accent/15">
          <div class="w-14 h-14 rounded-2xl feature-gradient-tan flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        ...
        <a href="https://app.revizie.ro/anunturi" class="group bg-gradient-to-br from-warning/10 to-card rounded-3xl p-8 hover:shadow-xl transition-all duration-300 border border-warning/15">
          <div class="w-14 h-14 rounded-2xl feature-gradient-warning flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="https://app.revizie.ro/asigurari/rca" class="group bg-gradient-to-br from-success/10 to-card rounded-3xl p-8 hover:shadow-xl transition-all duration-300 border border-success/15">
          <div class="w-14 h-14 rounded-2xl feature-gradient-success flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
            </svg>
          </div>
          <h3 class="text-xl font-bold text-foreground mb-3">Asigurari RCA</h3>
          <p class="text-foreground-muted mb-4">Calculezi pretul RCA online in 2 minute si compari oferte de la mai multi asiguratori. Polita emisa direct in cont.</p>
        ...
        <a href="https://app.revizie.ro" class="group bg-gradient-to-br from-info/10 to-card rounded-3xl p-8 hover:shadow-xl transition-all duration-300 border border-info/15">
          <div class="w-14 h-14 rounded-2xl feature-gradient-info flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <section class="py-20 bg-surface-muted relative">
    <div class="max-w-7xl mx-auto px-6">
      <div class="text-center mb-12">
        ...
        <h2 class="text-3xl md:text-4xl font-bold text-foreground mb-3">In curand pe platforma</h2>
        <p class="text-lg text-foreground-muted max-w-2xl mx-auto">Functionalitatile la care lucram acum. Lasa-ne emailul pe pagina fiecareia si te anuntam de indata ce intra live.</p>
      </div>

      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <a href="<?php echo home_url('/functii/servicii-auto/'); ?>" class="group bg-card border border-border-subtle rounded-2xl p-5 hover:border-accent/40 hover:shadow-md transition-all">
          <div class="w-11 h-11 rounded-xl bg-accent/10 text-accent flex items-center justify-center mb-3">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo home_url('/functii/tractari/'); ?>" class="group bg-card border border-border-subtle rounded-2xl p-5 hover:border-accent/40 hover:shadow-md transition-all">
          <div class="w-11 h-11 rounded-xl bg-warning/10 text-warning flex items-center justify-center mb-3">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo home_url('/functii/piese-auto/'); ?>" class="group bg-card border border-border-subtle rounded-2xl p-5 hover:border-accent/40 hover:shadow-md transition-all">
          <div class="w-11 h-11 rounded-xl bg-info/10 text-info flex items-center justify-center mb-3">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
            </svg>
          </div>
          <h3 class="font-semibold text-foreground mb-1">Marketplace piese</h3>
          <p class="text-xs text-foreground-muted">Piese de la furnizori verificati, compatibilitate AI.</p>
        </a>

        <a href="<?php echo home_url('/functii/anvelope/'); ?>" class="group bg-card border border-border-subtle rounded-2xl p-5 hover:border-accent/40 hover:shadow-md transition-all">
          <div class="w-11 h-11 rounded-xl bg-success/10 text-success flex items-center justify-center mb-3">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <section class="py-20 cta-gradient">
    <div class="max-w-4xl mx-auto px-6 text-center">
      ...
      <a href="https://app.revizie.ro/register" class="inline-flex items-center gap-2 px-8 py-4 bg-white text-foreground rounded-2xl font-bold hover:shadow-xl transition-all">
