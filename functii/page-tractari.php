 ...
 * (FEATURES.towing = false in src/lib/features.ts).
 */
get_header();
?>
  ...
  <section class="pt-32 pb-24 relative overflow-hidden hero-gradient">
    ...
    <div class="relative max-w-4xl mx-auto px-6 text-center">
      ...
      <p class="text-xl text-foreground-muted mb-10 leading-relaxed max-w-2xl mx-auto">
        Cerere de tractare direct din aplicatie, cu pretul afisat inainte sa accepti si firma confirmata in cateva minute. Tracking in timp real al masinii de tractare pana la locatia ta.
      </p>
    ...
    <div class="max-w-5xl mx-auto px-6">
      ...
      <div class="grid md:grid-cols-3 gap-6">
        <div class="bg-surface-muted rounded-2xl p-6 border border-border-subtle">
          ...
          <p class="text-sm text-foreground-muted">Aplicatia detecteaza locatia ta GPS si identifica firma disponibila cel mai aproape de tine.</p>
        </div>
        <div class="bg-surface-muted rounded-2xl p-6 border border-border-subtle">
          <div class="w-12 h-12 rounded-xl bg-warning/15 text-warning flex items-center justify-center mb-4">
          ...
          <p class="text-sm text-foreground-muted">Vezi pretul exact inainte sa confirmi cererea. Fara surprize si fara negocieri la fata locului.</p>
        </div>
        <div class="bg-surface-muted rounded-2xl p-6 border border-border-subtle">
          <div class="w-12 h-12 rounded-xl bg-warning/15 text-warning flex items-center justify-center mb-4">
          ...
          <p class="text-sm text-foreground-muted">Urmaresti masina de tractare pe harta, vezi timpul estimat de sosire si numarul soferului direct in cont.</p>
        </div>
      </div>
    </div>
  </section>
