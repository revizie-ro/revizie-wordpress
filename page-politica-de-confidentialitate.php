  ...
  <main class="pt-24 pb-20">
    <div class="max-w-4xl mx-auto px-6">
      ...
      <div class="flex items-center gap-4 mb-8">
        <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-success to-success/70 flex items-center justify-center">
        ...
        <div>
          ...
          <p class="text-foreground-subtle">Conform GDPR - Ultima actualizare: 4 Ianuarie 2026</p>
        </div>
      </div>
      ...
      <div class="prose prose-lg max-w-none">
          ...
          <div class="space-y-4 text-foreground-muted">
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <div class="bg-orange-50 rounded-xl p-4">
                ...
                <ul class="text-sm text-accent-strong space-y-1">
        ...
        <section class="mb-10">
          ...
          <div class="space-y-4">
            <p class="text-foreground-muted">Conform GDPR, aveti urmatoarele drepturi:</p>
            <div class="grid md:grid-cols-2 gap-4">
              <div class="border border-gray-200 rounded-xl p-4">
                <h4 class="font-semibold text-foreground mb-2">Dreptul de acces</h4>
                <p class="text-sm text-foreground-muted">Puteti solicita o copie a tuturor datelor pe care le detinem despre dumneavoastra.</p>
              </div>
              <div class="border border-gray-200 rounded-xl p-4">
                <h4 class="font-semibold text-foreground mb-2">Dreptul la rectificare</h4>
                <p class="text-sm text-foreground-muted">Puteti corecta datele incorecte sau incomplete direct din cont sau prin cerere.</p>
              </div>
              <div class="border border-gray-200 rounded-xl p-4">
                <h4 class="font-semibold text-foreground mb-2">Dreptul la stergere</h4>
                <p class="text-sm text-foreground-muted">Puteti solicita stergerea completa a datelor ("dreptul de a fi uitat").</p>
              </div>
              <div class="border border-gray-200 rounded-xl p-4">
                <h4 class="font-semibold text-foreground mb-2">Dreptul la portabilitate</h4>
                <p class="text-sm text-foreground-muted">Puteti primi datele intr-un format structurat pentru transfer.</p>
              </div>
              <div class="border border-gray-200 rounded-xl p-4">
                <h4 class="font-semibold text-foreground mb-2">Dreptul la opozitie</h4>
                <p class="text-sm text-foreground-muted">Puteti refuza prelucrarea datelor in anumite scopuri (ex: marketing).</p>
              </div>
              <div class="border border-gray-200 rounded-xl p-4">
                <h4 class="font-semibold text-foreground mb-2">Dreptul la restrictionare</h4>
                <p class="text-sm text-foreground-muted">Puteti limita modul in care va prelucram datele.</p>
              </div>
            </div>
            <p class="text-foreground-muted mt-4">Pentru exercitarea acestor drepturi, contactati-ne la: <a href="mailto:gdpr@revizie.ro" class="text-success hover:text-success font-medium">gdpr@revizie.ro</a></p>
          </div>
        </section>
        ...
        <section class="mb-10">
          ...
          <div class="bg-teal-50 rounded-xl p-6">
            <p class="text-foreground-muted mb-4"><strong>Responsabil Protectia Datelor (DPO):</strong></p>
            <ul class="space-y-2 text-foreground-muted mb-6">
              <li><strong>Email:</strong> <a href="mailto:gdpr@revizie.ro" class="text-success hover:text-success">gdpr@revizie.ro</a></li>
            ...
            <div class="border-t border-teal-200 pt-4">
              ...
              <ul class="mt-2 text-foreground-muted">
                <li>Website: <a href="https://www.dataprotection.ro" target="_blank" rel="noopener noreferrer" class="text-success hover:text-success">www.dataprotection.ro</a></li>
