  ...
  <section class="pt-32 pb-24 relative overflow-hidden hero-gradient">
    ...
    <div class="relative max-w-4xl mx-auto px-6 text-center">
      ...
      <p class="text-xl text-foreground-muted mb-10 leading-relaxed max-w-2xl mx-auto">
        Recomandari de anvelope bazate pe masina ta din garaj, stilul de condus si bugetul disponibil. Asteptam finalizarea integrarii cu Netopia pentru checkout sigur online.
      </p>
    ...
    <div class="max-w-5xl mx-auto px-6">
      ...
      <div class="grid md:grid-cols-3 gap-6">
        <div class="bg-surface-muted rounded-2xl p-6">
          ...
          <p class="text-sm text-foreground-muted">Aplicatia analizeaza masina ta + cum o folosesti si iti propune top 3 anvelope.</p>
        </div>
        <div class="bg-surface-muted rounded-2xl p-6">
          <div class="w-12 h-12 rounded-xl bg-success/15 text-success flex items-center justify-center mb-4">
          ...
          <p class="text-sm text-foreground-muted">Verificare automata fata de dimensiunile mentionate in CIV-ul masinii.</p>
        </div>
        <div class="bg-surface-muted rounded-2xl p-6">
          <div class="w-12 h-12 rounded-xl bg-success/15 text-success flex items-center justify-center mb-4">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
          </div>
          <h3 class="text-lg font-semibold text-foreground mb-2">Pret comparativ</h3>
          <p class="text-sm text-foreground-muted">Vezi pretul din mai multe magazine si alegi cel mai bun deal pentru tine.</p>
        </div>
      </div>
    </div>
  </section>
