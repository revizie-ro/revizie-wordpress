...
/**
 * Google Pay + Apple Pay marks. NETOPIA's hosted checkout offers both wallets,
 * but the bundled NETOPIA badge (revizie_render_netopia_logo) only shows the
 * wordmark + Visa + Mastercard — so these marks advertise the wallets up front,
...
function revizie_get_logo_url() {
    ...
    // Default to the transparent wordmark (dark text) — same logo as the app,
    // no baked-in background so it blends on any light surface.
    return REVIZIE_THEME_URI . '/assets/img/logo-dark.png';
}
